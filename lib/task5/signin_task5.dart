...
class signin_task5 extends StatefulWidget {
  const signin_task5({Key? key}) : super(key: key);

  @override
  State<signin_task5> createState() => _signin_task5State();
}

class _signin_task5State extends State<signin_task5> {
                      ...
                      TextButton(
                        onPressed: () {
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => resert_password()));
                        },
                        child: Text(
